# TEMPLATE: Cheat Sheet · Druck · Beginner · Ausführlich
# Trigger: [THEMA] - Druck-Beginner-Ausfuehrlich
#
# ANWEISUNG AN CLAUDE:
...
# MODUS: DRUCK | ZIELGRUPPE: BEGINNER | UMFANG: AUSFÜHRLICH
...
SECTIONS = [
    ...
    ('[KARTE 2 TITEL]', 'blue', [
        ('[Keyword 1]',  '[Beschreibung 1]'),
        # ... 10–12 Einträge, einfache Sprache
    ]),
