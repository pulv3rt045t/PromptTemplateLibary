# TEMPLATE: Cheat Sheet · Web/Bildschirm · Experte · Kompakt
# Trigger: [THEMA] - Web-Experte-Kompakt
#
# ANWEISUNG AN CLAUDE:
...
# MODUS: WEB/BILDSCHIRM (dunkler Hintergrund) | ZIELGRUPPE: EXPERTE | UMFANG: KOMPAKT
