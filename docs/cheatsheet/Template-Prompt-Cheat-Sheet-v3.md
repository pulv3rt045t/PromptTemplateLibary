# TEMPLATE: Cheat Sheet – nach Universalvorlage (Template-Prompt-PDF-Base-v1.md)
# Datei: Template-Prompt-Cheat-Sheet-v3.md
# Aufruf im Chat: "CheatSheet zu [THEMA]" oder "Template-Prompt-Cheat-Sheet-v3"
#
# ═══════════════════════════════════════════════════════════
...
#   Druck    → Farben aus DRUCK-PALETTE
#   Web      → Farben aus WEB-PALETTE
#   Kompakt  → 6–8 Einträge pro Karte, einfache Sprache
#   Ausführlich → 10–12 / 8–10 Einträge, dichte Sprache
...
#   MODIFIERS: genau 10 · TIPS: genau 6
# ═══════════════════════════════════════════════════════════
...
# ── FARBPALETTE: je nach gewähltem Modus einsetzen ──────────
# DRUCK (hell) – Standard:
C = {
...
# WEB/BILDSCHIRM (dunkel) – alternativ einsetzen wenn Modus=Web:
# C = {
#     'green':  colors.HexColor('#1a6b00'),
#     'blue':   colors.HexColor('#004fa3'),
#     'purple': colors.HexColor('#7a00b8'),
...
TIPP       = 'Tipp: [Themenspezifischer Merksatz]'
...
# CODE-BOX (wenn Code-Box gewählt): Titel, Farbe, Zeilen (max. 16)
CODE_BOX = ('[PRAXISBEISPIEL – USE CASE]', 'blue', [
    '# [Kommentar Schritt 1]',
    '[code zeile 1]',
    '',
    '# [Kommentar Schritt 2]',
...
# FORMEL-BOX (wenn Formel-Box gewählt): CODE_BOX = None setzen
# CODE_BOX = None
# FORMEL_LABEL   = '[FORMEL-TITEL]'
# FORMEL_TEILE   = [('[Teil1]','green'), (' + [Teil2]','blue'), (' + [Teil3]','purple')]
# FORMEL_BEISPIEL = '[Konkretes Beispiel]'
