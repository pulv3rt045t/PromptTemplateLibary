...
# Datei: Template-Prompt-PDF-Base-v2.md
# Aufruf im Chat: "PDF zu [THEMA]" oder "Template-Prompt-PDF-Base-v2"
#
# ═══════════════════════════════════════════════════════════
...
#   - Stichpunkte: max. 60 Zeichen pro Zeile (PDF-Spaltenbreite beachten)
#   - Abschnittstitel: kurz & prägnant, max. 30 Zeichen
#   - Tabellenzellen: max. 25 Zeichen pro Zelle für lesbare Ausgabe
#   - Parallelstruktur: alle Stichpunkte eines Abschnitts gleich aufgebaut
#   - Tabellenheader: klar & einzeilig
# ═══════════════════════════════════════════════
